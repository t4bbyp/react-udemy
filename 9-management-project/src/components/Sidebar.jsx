...
export default function Sidebar({ title, onSelectProject, onNew, projects }) {
  return (
    <>
      <aside
        className="w-1/3 px-8 py-16 bg-stone-900 
      ...
      >
        ...
        <button
          onClick={() => onNew(true)}
          className="px-4 py-2 text-xs md:text-base rounded-md bg-stone-700
